...
declare class ZCompressorImplementation implements MZXBX_AudioFilterPlugin {
...
declare function initZC(): void;
declare function newZvoogCompreImplementation(): MZXBX_AudioFilterPlugin;
