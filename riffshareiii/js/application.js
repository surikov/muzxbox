...
class LeftBar {
    ...
    createLeftPanel() {
        ...
        for (let zz = 0; zz < zoomPrefixLevelsCSS.length - 1; zz++) {
            ...
            let protitle = { x: 0, y: -2 * zoomPrefixLevelsCSS[zz].minZoom, text: 'Debug title string', css: 'leftReadProjectTitle' + zoomPrefixLevelsCSS[zz].prefix };
            let profirst = { x: 0, y: 0, text: 'Debug title string', css: 'leftReadFirstTitle' + zoomPrefixLevelsCSS[zz].prefix };
