...
declare class ShareExportPlugin {
    callbackID: string;
    hostProject: Zvoog_Project | null;
    previewArrayBuffer: ArrayBuffer | null;
    bgPar: string;
    txtPar: string;
    constructor();
    init(): void;
    fogClick(): void;
    sendRequest(token: string, url: string, method: string, jsonOrArrayBuffer: string | ArrayBuffer, onError: (info: string) => void, onDone: (xmlHttpRequest: XMLHttpRequest, vProgressEven: ProgressEvent) => void): void;
