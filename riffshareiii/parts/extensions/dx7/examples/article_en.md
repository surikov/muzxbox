...
<spoiler title="Код примера страницы HTML с поясняющими комментариями">
...
<spoiler title="Код примера с комментариями">
...
<spoiler title="Вот код фазовой модуляции из предидущего примера, но уже через AudioWorkletProcessor">
