...
class SignVerifyTest {
    startTest() {
        this.dumpKeyPEMs((signPEM, verifyPEM) => {
            ...
            this.buildMessageSignature(testMessage, signPEM, (signaturePEM) => {
                console.log('signaturePEM', signaturePEM);
                this.verifyMessageSignature(testMessage, signaturePEM, verifyPEM, (same) => {
    ...
    buildMessageSignature(message, signPEM, onDone) {
