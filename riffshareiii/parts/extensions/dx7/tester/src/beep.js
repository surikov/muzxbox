...
var BeepDX7 = /** @class */ (function () {
    ...
    BeepDX7.prototype.setupOperator = function (cfg) {
    ...
    BeepDX7.prototype.startOperator = function (when, duration, note) {
        ...
        var detuneRatio = Math.pow(OCTAVE_1024, this.detune);
        var freqRatio = this.freqCoarse * (1 + this.freqFine / 100);
        var opefrequency = detuneRatio * freqRatio * this.frequencyFromNoteNumber(note);
...
*/
    ...
    BeepDX7.prototype.frequencyFromNoteNumber = function (note) {
        return 440 * Math.pow(2, (note - 69) / 12);
    };
    ;
    BeepDX7.prototype._____________startOperator = function (level1, rate1, level2, rate2, level3, rate3, level4, rate4, when, duration, pitch, oscMode, freqCoarse, freqFine, detune, volume) {
        //if (this.onNotOff) {
...
*/
    ...
    BeepDX7.prototype.connectToOutputNode = function (outNode) {
        this.outGain.connect(outNode);
    };
    BeepDX7.prototype.connectToCarrier = function (opDX7) {
    ...
    BeepDX7.prototype.connectToSelf = function () {
    };
    return BeepDX7;
}());
