...
declare let inames: ChordPitchPerformerUtilMIDI;
...
declare function beat_duration(beat: Beat): Zvoog_MetreMathType;
...
declare function stringFret2pitch(stringNum: number, fretNum: number, tuning: number[], octave: number, tone: number): number;
declare function findVolumeInstrument(program: number): {
    idx: number;
    ratio: number;
};
declare function addScoreInsTrack(project: Zvoog_Project, scoreTrack: Track, targetId: string): void;
declare function convertScore2Project(score: Score): void;
declare function arrangeFilters(project: Zvoog_Project): void;
declare function arrangeDrums(project: Zvoog_Project): void;
declare function arrangeTracks(project: Zvoog_Project): void;
declare function addRepeats(project: Zvoog_Project, score: Score): void;
declare function cloneOneMeasure(project: Zvoog_Project, from: number, to: number): void;
declare function cloneAndRepeat(project: Zvoog_Project, start: number, altEnd: number, end: number, count: number): number;
declare function addHeaderText(text: string, label: string, firstBar: Zvoog_CommentMeasure): void;
declare function addBarText(text: string, project: Zvoog_Project, barIdx: number): void;
declare function addScoreLyrics(project: Zvoog_Project, score: Score): void;
declare function dumpFile(filepath: string): void;
