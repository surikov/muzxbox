...
class PercussionWebAudioFontLoader {
    ...
    drumInfo(n) {
        ...
        return {
            variable: '_drum_' + key,
            url: 'https://daw1024.com/sound/128' + key + '.js',
            pitch: p,
...
class PercussionWebAudioFontPlayer {
    constructor() {
        this.envelopes = [];
        this.loader = new PercussionWebAudioFontLoader();
        this.afterTime = 0.05;
...
class PercussionDrumKitImplementation {
    constructor() {
        this.player = new PercussionWebAudioFontPlayer();
        this.loader = new PercussionWebAudioFontLoader();
        this.preset = null;
