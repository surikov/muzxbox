...
class MM_WebAudioFontLoader {
    ...
    ;
    instrumentInfo(n) {
        var key = this.util.tonechordinstrumentKeys()[n];
        var p = 1 * parseInt(key.substring(0, 3));
        return {
            variable: '_tone_' + key,
            url: 'https://daw1024.com/sound/' + key + '.js',
...
class MM_WebAudioFontPlayer {
    constructor() {
        this.envelopes = [];
        this.loader = new MM_WebAudioFontLoader(this);
        this.afterTime = 0.05;
...
class StrumPerformerImplementation {
    constructor() {
        ...
        this.loudness = 0.5;
        this.up = false;
        this.strumModeFlat = 0;
        this.strumModeDown = 1;
        this.strumModeUp = 2;
        this.strumModeSnap = 3;
        this.strumModePong = 4;
