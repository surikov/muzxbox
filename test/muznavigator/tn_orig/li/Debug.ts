 ...
 */
//export 
function assert(statement: boolean, error: string): asserts statement {
	if (!statement) {
 ...
 */
//export 
function assertRange(value: number, gte: number, lte = Infinity): void {
 ...
 */
//export 
function assertContextRunning(context: BaseContext): void {
 ...
 */
//export 
function enterScheduledCallback(insideCallback: boolean): void {
 ...
 */
//export 
function assertUsedScheduleTime(time?: Time): void {
	if (
		isUndef(time) &&
