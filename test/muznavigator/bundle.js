! function (t, e) {
    ...
    return (() => {
        ...
        class LaPitchShift extends Ca {
            constructor() {
                console.log('------------------------LaPitchShift');
                const t = ui(LaPitchShift.getDefaults(), arguments, ["pitch"]);
                console.log('super', t);
                super(t);
                ...
                console.log('LaPitchShift done', this);
            }
            static getDefaults() {
                return Object.assign(Ca.getDefaults(), {
                    pitch: 0,
            ...
            set pitch(t) {
                ...
                let e = 0;
                //t < 0
                //  ? (this._lfoA.min = 0, this._lfoA.max = this._windowSize, this._lfoB.min = 0, this._lfoB.max = this._windowSize, e = zi(t - 1) + 1)
                //: (this._lfoA.min = this._windowSize, this._lfoA.max = 0, this._lfoB.min = this._windowSize, this._lfoB.max = 0, e = zi(t) - 1), this._frequency.value = e * (1.2 / this._windowSize)
                if (t < 0) {
                    this._lfoA.min = 0;
