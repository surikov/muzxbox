 ...
 */
//export 
function onContextInit(cb: (ctx: Context) => void): void {
 ...
 */
//export 
function initializeContext(ctx: Context): void {
 ...
 */
//export 
function onContextClose(cb: (ctx: Context) => void): void {
	notifyCloseContext.push(cb);
}

//export 
function closeContext(ctx: Context): void {
