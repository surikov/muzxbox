declare class StretchShiftFxPlugin implements MZXBX_AudioFilterPlugin {
    base: GainNode;
...
declare function createStretchShiftFx(): MZXBX_AudioFilterPlugin;
declare function testit(): void;
