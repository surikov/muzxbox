...
,
    ...
    /*}, {
        duration: 1, items: [
            { skip: 0, channelId: 'ch1', pitch: 12 * 5 + 0, slides: [{ duration: 0.25, delta: 0 }] }
            , { skip: 0, channelId: 'ch1', pitch: 12 * 5 + 4, slides: [{ duration: 0.25, delta: 0 }] }
            , { skip: 0, channelId: 'ch1', pitch: 12 * 5 + 7, slides: [{ duration: 0.25, delta: 0 }] }
            , {
                skip: 0.25, channelId: 'ch1', pitch: 12 * 5 + 12, slides: [
    ...
    , channels: [{
        ...
        //, performer: { id: 'p1', kind: 'drums_performer_1_test', properties: '40' }
