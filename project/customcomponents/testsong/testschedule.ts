let testSchedule: MZXBX_Schedule = {
    ...
    /*}, {
        duration: 1, items: [
            { skip: 0, channelId: 'ch1', pitch: 12 * 5 + 0, volume: 0.33, slides: [{ duration: 0.25, delta: 0 }] }
            , { skip: 0, channelId: 'ch1', pitch: 12 * 5 + 4, volume: 0.33, slides: [{ duration: 0.25, delta: 0 }] }
            , { skip: 0, channelId: 'ch1', pitch: 12 * 5 + 7, volume: 0.33, slides: [{ duration: 0.25, delta: 0 }] }
            , {
                skip: 0.25, channelId: 'ch1', pitch: 12 * 5 + 12, volume: 0.33, slides: [
    ...
    , channels: [{
        ...
        , performer: { id: '22', kind: 'sinewave_performer_1_test', properties: 'square' }
    }]
    , filters: [
